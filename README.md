...
- [Using Pod Identity, replacement ](docs.aws.amazon.com/eks/latest/userguide/pod-identities.html)
...
- [EKS connector, allowing the management of any Kubernetes cluster from EKS](https://docs.aws.amazon.com/eks/latest/userguide/eks-connector.html)
- [Security on EKS auto-mode](https://docs.aws.amazon.com/eks/latest/userguide/auto-security.html)
- [CDK - Cloud development kit](https://docs.aws.amazon.com/cdk/v2/guide/home.html)
- [CDK8S, same idea of the CDK but producing kubernetes manifests](https://cdk8s.io/)
